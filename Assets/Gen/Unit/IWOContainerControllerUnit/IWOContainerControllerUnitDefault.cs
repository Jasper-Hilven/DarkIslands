namespace DarkIslands{
  public class IWOContainerControllerUnitDefault: IUnitChanged
  {
    public virtual void Destroy(){
    }
    public virtual void Init(Unit Unit, IWOContainerControllerUnitFactory IWOContainerControllerUnitFactory){
    }

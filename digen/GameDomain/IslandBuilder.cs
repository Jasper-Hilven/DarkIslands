...
namespace DarkIslandGen
{
    public class IslandBuilder
    {
        public static List<ModelClass> GetIslandParts(Property position, Property circleProps, TVariable modelToEntity)
        {
            ...
            islandParts.Add(new ModelClass(){Name = "InterIslandCollision",ParentRelation = island,
            ...
            //View
            islandParts.Add(new ModelClass(){Name = "IslandUnityView",ParentRelation = island,
